        ...
        <div class="col-md-6 col-12 ms-md-3">
          <form action="/admin/kelas" method="POST">
            ...
            <div class="d-md-flex justify-content-end mb-4 pb-3">
              <button class="btnnn btn-simpan px-3" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="mb-1 bi bi-check-lg" viewBox="0 0 16 16">
